    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fenzi_AccountBooks", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fenzi_Relations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fenzi_Relations_AbpUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                name: "Fenzi_AccountBookLines",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    AccountBookId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    RelationId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    PersonName = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fenzi_AccountBookLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fenzi_AccountBookLines_Fenzi_AccountBooks_AccountBookId",
                        column: x => x.AccountBookId,
                        principalTable: "Fenzi_AccountBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Fenzi_AccountBookLines_Fenzi_Relations_RelationId",
                        column: x => x.RelationId,
                        principalTable: "Fenzi_Relations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fenzi_AccountBookLines_AccountBookId",
                table: "Fenzi_AccountBookLines",
                column: "AccountBookId");

            migrationBuilder.CreateIndex(
                name: "IX_Fenzi_AccountBookLines_RelationId",
                table: "Fenzi_AccountBookLines",
                column: "RelationId");

            migrationBuilder.CreateIndex(
                name: "IX_Fenzi_Relations_CreatorId",
                table: "Fenzi_Relations",
                column: "CreatorId");
