...
namespace FenziBill.Migrations
{
    ...
    partial class FenziBillDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FenziBill.Entitys.AccountBook", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("Fenzi_AccountBooks", (string)null);
                });

            modelBuilder.Entity("FenziBill.Entitys.AccountBookLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Fenzi_AccountBookLines", (string)null);
                });

            modelBuilder.Entity("FenziBill.Entitys.Relation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Fenzi_Relations", (string)null);
                });
            ...
            modelBuilder.Entity("FenziBill.Entitys.AccountBookLine", b =>
                {
                    b.HasOne("FenziBill.Entitys.AccountBook", null)
                        .WithMany("AccountBookLines")
                        .HasForeignKey("AccountBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FenziBill.Entitys.Relation", null)
                        .WithMany()
